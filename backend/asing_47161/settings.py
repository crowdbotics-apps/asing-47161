"""
Django settings for asing_47161 project.
...
WSGI_APPLICATION = 'asing_47161.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "asing_47161 API",
    "DESCRIPTION": "API documentation for asing_47161 App",
    "VERSION": "v1",
}
